    ...
    >
      ...
      >
        ...
        <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
          <div
            class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3"
          >
            <div
            ...
            >
              ...
              <a
                href="#_"
                class="relative flex mt-2 text-sm font-medium text-orange-500 underline"
                >Learn More</a
              >
            </div>
          </div>
        ...
        <div class="flex-col items-center">
          ...
          >
            <p
              class="my-5 text-base font-medium tracking-tight text-orange-500 uppercase"
            >
              O que nossos clientes acham do nosso trabalho
            </p>
            <h2
            ...
            <p class="my-6 text-xl font-medium text-gray-500">
              Trabalho de qualidade e excelência!
            </p>
          </div>
          <div
              ...
              >
                <div class="flex flex-col pr-8">
                  <div class="relative pl-12">
                    <svg
                      class="absolute left-0 w-10 h-10 text-orange-500 fill-current"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 100 125"
                    >
                      <path
