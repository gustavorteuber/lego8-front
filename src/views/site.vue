  ...
  <body class="overflow-x-hidden antialiased">
    ...
    <header class="relative z-50 w-full h-24">
      ...
      >
        ...
        >
          <img class="w-auto h-20 fill-current" src="../assets/leg8.png" />
          <span class="ml-3 text-xl text-gray-800"
            >Leg8 Serviços<span class="text-orange-500">.</span></span
          >
        </a>
        ...
        >
          <a
            href="#"
            class="ml-0 mr-0 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-orange-600"
            >Home</a
          >
          <a
            href="#features"
            class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-orange-600"
            >Nossa História</a
          >
          <a
            href="#testimonials"
            class="font-bold duration-100 transition-color hover:text-orange-600"
            >Feedback</a
          >
          <div
          ...
          >
            <defs>
              <linearGradient x1="0%" y1="0%" x2="100%" y2="100%" id="c">
                <stop stop-color="#44403c" offset="0%" />
    ...
    >
      ...
      >
        ...
        >
          ...
          >
           Nossos serviços na indústria são projetados para ajudar nossos clientes a alcançar os mais altos níveis de qualidade em seus produtos e processos. Tanto em seu parque fabril como no endereço de seus clientes. Utilizamos ferramentas e metodologias comprovadas para garantir que cada etapa do processo de produção seja executada com a máxima qualidade e eficiência
          </p>
          <a
            href="https://wa.me/5547984074659"
            class="z-10 relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-orange-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0"
            >Entre em contato!</a
          >
          <!-- Integrates with section -->
          <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
            <p
              class="z-10 mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase"
            >
              Nossos Clientes:
            </p>
          </div>
    ...
    >
      ...
      >
        <h2
          class="my-5 text-base font-medium tracking-tight text-orange-500 uppercase"
        >
          Nossa História
        </h2>
        <h3
    ...
    <footer
      class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200"
    >
      <div
      ...
      >
        ...
        >
          ...
          >
            <span class="flex items-start sm:items-center">
              <!-- <img
                src="../assets/leg8.png"
                class="w-auto h-10 text-gray-800 fill-current"
              /> -->
            </span>
          </a>
        ...
        <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
          ...
          <div class="flex flex-col w-full text-gray-700">
            <div
              class="inline-block px-3 py-2 mt-5 font-bold text-gray-800 uppercase md:mt-0"
            >
              Follow Us
            </div>
      ...
      <div
        class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100"
      >
        © 2023 Leg8 Serviços. Todos os direitos reservados.
      </div>
    </footer>
  </body>
</template>
